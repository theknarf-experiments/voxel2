...
pub fn all() -> Vec<(&'static str, f64, u64)> {
    [
        ...
        ("lod_passes", &voxel_core::csg::LOD_PASSES),
        ("lod_committed", &voxel_core::csg::LOD_COMMITTED),
        ("ops_wait", &voxel_core::csg::OPS_WAIT),
        ("ops_answer", &voxel_core::csg::OPS_ANSWER),
        ("ops_waited", &voxel_core::csg::OPS_WAITED),
        ("ops_is_idle", &voxel_core::csg::OPS_IS_IDLE),
        ("ops_covered", &voxel_core::csg::OPS_COVERED),
...
pub fn reset() {
    for s in [
        ...
        &voxel_core::csg::LOD_PASSES,
        &voxel_core::csg::LOD_COMMITTED,
        &voxel_core::csg::OPS_WAIT,
        &voxel_core::csg::OPS_ANSWER,
        &voxel_core::csg::OPS_WAITED,
        &voxel_core::csg::OPS_IS_IDLE,
        &voxel_core::csg::OPS_COVERED,
